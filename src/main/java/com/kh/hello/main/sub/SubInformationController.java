...
public class SubInformationController {
	...
	public void searchAreaGame(HttpServletRequest request, HttpServletResponse response, @RequestParam int areaCode, @RequestParam String sigunguCode, @RequestParam int contenttypeid) throws IOException{
		request.setCharacterEncoding("UTF-8");
		response.setContentType("text/html; charset=UTF-8");
	...
	public void gameSearchCondition(HttpServletRequest request, HttpServletResponse response, @RequestParam int contenttypeid, @RequestParam String areaCode, @RequestParam String sigunguCode, @RequestParam String cat1, @RequestParam String cat2, @RequestParam String cat3, @RequestParam int pageNo) throws IOException{
		request.setCharacterEncoding("UTF-8");
		response.setContentType("text/html; charset=UTF-8");
	...
	/*@RequestMapping(value="detailOverview.sub")
	public void detailOverview(HttpServletRequest request, HttpServletResponse response, @RequestParam int contenttypeid, @RequestParam int contentid) throws IOException{
		request.setCharacterEncoding("UTF-8");
		response.setContentType("text/html; charset=UTF-8");
