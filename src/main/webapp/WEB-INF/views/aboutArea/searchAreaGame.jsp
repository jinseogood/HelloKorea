			...
			<div class="row">
				...
				<div class="col-lg-4" align="left">
					...
					<div class="col-lg-12 col-md-12 col-sm-12" align="left">
						...
						<br>
						<input type="radio" class="gameSearch" id="festival" name="festivalgroup" style="width:15px; height:15px;"/>　<label for="festival">축제</label><br>
						<input type="radio" class="gameSearch" id="landmark" name="festivalgroup" style="width:15px; height:15px;"/>　<label for="landmark">랜드마크</label><br>
						<input type="radio" class="gameSearch" id="shopping" name="festivalgroup" style="width:15px; height:15px;"/>　<label for="shopping">쇼핑</label><br>
						<input type="radio" class="gameSearch" id="musium" name="festivalgroup" style="width:15px; height:15px;"/>　<label for="musium">박물관</label><br>
						<input type="radio" class="gameSearch" id="amusmenetPark" name="festivalgroup" style="width:15px; height:15px;"/>　<label for="amusmentPark">놀이공원</label><br>
						<input type="radio" class="gameSearch" id="spar" name="festivalgroup" style="width:15px; height:15px;"/>　<label for="spar">스파</label><br>
						<input type="radio" class="gameSearch" id="zoo" name="festivalgroup" style="width:15px; height:15px;"/>　<label for="zoo">동물원/아쿠아리움</label><br>
					</div>
