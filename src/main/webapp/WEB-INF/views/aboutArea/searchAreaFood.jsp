			...
			<div class="row">
				...
				<div class="col-lg-4" align="left">
					...
					<div class="col-lg-12 col-md-12 col-sm-12" align="left">
						...
						<br>
						<input type="radio" class="foodSearch" id="fiveStar" name="foodAvg" style="width:15px; height:15px;"/>　<label for="fiveStar">★★★★★</label><br>
						<input type="radio" class="foodSearch" id="fourStar" name="foodAvg" style="width:15px; height:15px;"/>　<label for="fourStar">★★★★☆ 이상</label><br>
						<input type="radio" class="foodSearch" id="threeStar" name="foodAvg" style="width:15px; height:15px;"/>　<label for="threeStar">★★★☆☆ 이상</label><br>
						<input type="radio" class="foodSearch" id="twoStar" name="foodAvg" style="width:15px; height:15px;"/>　<label for="twoStar">★★☆☆☆ 이상</label><br>
					</div>
