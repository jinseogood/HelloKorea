			...
			<div class="row">
				...
				<div class="col-lg-4" align="left">
					...
					<div class="col-lg-12 col-md-12 col-sm-12" align="left">
						...
						<br>
						<input type="checkbox" class="hotelSearch" id="wifi" name="wifi" style="width:15px; height:15px;"/>　<label for="wifi">무료 와이파이</label><br>
						<input type="checkbox" class="hotelSearch" id="parking" name="parking" style="width:15px; height:15px;"/>　<label for="parking">무료 주차</label><br>
						<input type="checkbox" class="hotelSearch" id="fitness" name="fitness" style="width:15px; height:15px;"/>　<label for="fitness">피트니스 센터</label><br><br>
					</div>
					...
					<div class="col-lg-12 col-md-12 col-sm-12" align="left">
						...
						<br>
						<input type="checkbox" class="hotelSearch" id="hongdae" name="hongdae" style="width:15px; height:15px;"/>　<label for="hongdae">홍대</label><br>
						<input type="checkbox" class="hotelSearch" id="jongro" name="jongro" style="width:15px; height:15px;"/>　<label for="jongro">광화문/종로</label><br>
						<input type="checkbox" class="hotelSearch" id="myungdong" name="myungdong" style="width:15px; height:15px;"/>　<label for="myungdong">명동/남대문</label><br><br>
					</div>
					...
					<div class="col-lg-12 col-md-12 col-sm-12" align="left">
						...
						<br>
						<input type="radio" class="hotelSearch" id="fiveStar" name="hotelAvg" style="width:15px; height:15px;"/>　<label for="fiveStar">★★★★★</label><br>
						<input type="radio" class="hotelSearch" id="fourStar" name="hotelAvg" style="width:15px; height:15px;"/>　<label for="fourStar">★★★★☆ 이상</label><br>
						<input type="radio" class="hotelSearch" id="threeStar" name="hotelAvg" style="width:15px; height:15px;"/>　<label for="threeStar">★★★☆☆ 이상</label><br>
						<input type="radio" class="hotelSearch" id="twoStar" name="hotelAvg" style="width:15px; height:15px;"/>　<label for="twoStar">★★☆☆☆ 이상</label><br>
					</div>
				...
				<div class="col-lg-8" align="center">
				    ...
				    <div class="tm-home-box-3 detailHover" onclick="location.href='${contextPath}/deatilHotel'">
