...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAf5xrmNMwmRYe-jdx4N3ItbdKDOJryoj4&language=${ sessionScope.tVal }&callback=initialize" async defer></script>
